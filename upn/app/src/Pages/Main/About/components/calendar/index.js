...
const Calendar = (props) =>{
 const Schedule = ({ d })=>{
   ...
   (<View style={{ marginBottom:15, padding:15, borderWidth: 1, borderColor:'#ccc', borderRadius:8 }}>
   ...
   <View style={{ borderColor:'#ccc', borderRadius:8, paddingTop:6, paddingBottom:6, paddingLeft:10, paddingRight:10,  borderWidth:1 }}>
 ...
 <HamburgerIcon {...props}/>      
 <View style={{ marginBottom:15, justifyContent:'center', alignItems:'center', backgroundColor:'#df0d55'  }}>
  <Text style={[CalendarStyle.mainTitle, CalendarStyle.textCenter]}>UPSC Exam Calendar 2023/24</Text>
 </View>
