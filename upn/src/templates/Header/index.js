...
const Header = ({ activeId, menulinks })=>{
 ...
 <div className="upper-header">
    <div className="upper-header-flex">
      ...
      <Icon type="FontAwesome" name="fa-envelope" size={16} color="#5d607f" className="desktop-view" />
      <span className="desktop-view txt-email">support@upscprepnetwork.com</span>
