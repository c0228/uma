...
const data = {
 ...
 exams:{
    ...
    "Combined Defence Services Examination (CDS)":"This exam is conducted for recruitment into the Indian Military Academy (IMA), Indian Naval Academy (INA), Air Force Academy (AFA), and Officers Training Academy (OTA).",
    "National Defence Academy Examination (NDA)":"This exam is conducted for admission to the Army, Navy, and Air Force wings of the National Defence Academy. It is a gateway for young men to join the defence forces as officers.",
    ...
    "Naval Academy Examination (NA)":"This exam is conducted for admission to the Indian Naval Academy, alongside the NDA examination, but specifically for candidates aspiring to join the Indian Navy.",
    "Combined Geoscientist and Geologist Examination (CGG)":"The Combined Geoscientist and Geologist (CGG) Examination is conducted by the Union Public Service Commission (UPSC) to recruit geologists, geophysicists, and hydrogeologists for various government departments and ministries in India.",
    "Central Armed Police Forces Examination (CAPF)":"The Central Armed Police Forces (CAPF) Examination is conducted by the Union Public Service Commission (UPSC) to recruit Assistant Commandants in various paramilitary forces in India.",
